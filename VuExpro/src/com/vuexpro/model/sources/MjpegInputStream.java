...
public class MjpegInputStream extends ISapDataInputStream {
...
//		Log.d("mContentLength",mContentLength+"");
		reset();
		...
		ByteArrayInputStream res = new ByteArrayInputStream(frameData);
